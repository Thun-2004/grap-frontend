        ...
        <div className="p-7">
            ...
            <div className="flex flex-col mt-12">
                <div className="flex justify-between space-x-10 mb-3">
                    <button type="button">
                        <h2 className='sub-title active:text-blue-600'>Ongoing</h2>
                    </button>
                    <button type="button">
                        <h2 className='sub-title active:text-green-600'>Completed</h2>
                    </button>
                    <button type="button" onClick={ handleState }>
                        <h2 className='sub-title active:text-red-600'>Canceled/Failed</h2>
                    </button>
                </div>
